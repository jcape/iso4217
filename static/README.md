...
- `zerocopy`: Enables the derivation of [`zerocopy`](https://docs.rs/zerocopy) traits (specifically, [`TryFromBytes`](zerocopy::TryFromBytes) and [`IntoBytes`](zerocopy::IntoBytes)) on the [`Currency`] enum.
...
[crate-link]: https://crates.io/crates/iso4217-static/0.2.3
[docs-image]: https://img.shields.io/docsrs/iso4217-static?style=for-the-badge
[docs-link]: https://docs.rs/crate/iso4217-static/0.2.3/iso4217_static
[msrv-image]: https://img.shields.io/crates/msrv/iso4217-static/0.2.3?style=for-the-badge
